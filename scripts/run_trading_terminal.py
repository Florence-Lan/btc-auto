...
STATE_PATH = DATA / "paper_trading/macro_candidate_v2_state.json"
REPORT_PATH = DATA / "paper_trading/macro_candidate_v2_report.json"
STDOUT_PATH = DATA / "runtime/execution_supervisor_stdout.log"
STDERR_PATH = DATA / "runtime/execution_supervisor_stderr.log"
CANDIDATE_PATH = ROOT / "config/shadow_candidate_macro_20260720.json"
